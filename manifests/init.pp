...
class datadog_agent(
  ...
  validate_legacy(Numeric, 'validate_re', $_dogstatsd_port, '^\d*$')
  validate_legacy(String, 'validate_string', $statsd_histogram_percentiles)
  validate_legacy(Numeric, 'validate_re', $_statsd_forward_port, '^\d*$')
  validate_legacy(String, 'validate_string', $proxy_host)
  validate_legacy(Numeric, 'validate_re', $_proxy_port, '^\d*$')
  validate_legacy(String, 'validate_string', $proxy_user)
  validate_legacy(String, 'validate_string', $proxy_password)
  validate_legacy(Numeric, 'validate_re', $_graphite_listen_port, '^\d*$')
  ...
  validate_legacy(Numeric, 'validate_re', $_listen_port, '^\d*$')
  ...
  validate_legacy(Numeric, 'validate_re', $_pup_port, '^\d*$')
  ...
  validate_legacy(Numeric, 'validate_re', $_syslog_port, '^\d*$')
