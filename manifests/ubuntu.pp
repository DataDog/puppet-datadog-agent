# @summary Contains the DataDog agent installation mechanism for Debian derivatives
#
#
...
# @param agent_flavor
# @param apt_trusted_d_keyring
# @param apt_usr_share_keyring
# @param apt_default_keys
#
