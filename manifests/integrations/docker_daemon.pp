# @summary Install the necessary configuration for the docker integration
#
#
# @param group
...
class datadog_agent::integrations::docker_daemon (
  String $group = 'docker',
  Stdlib::Absolutepath $docker_root = '/',
  Integer $timeout = 10,
  String $api_version = 'auto',
  Boolean $tls = false,
  Stdlib::Absolutepath $tls_client_cert = '/path/to/client-cert.pem',
  Stdlib::Absolutepath $tls_client_key = '/path/to/client-key.pem',
  Stdlib::Absolutepath $tls_cacert = '/path/to/ca.pem',
