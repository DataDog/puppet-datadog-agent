# @summary Contains the agent installation mechanism for the Datadog module
#
#
# @param dd_url
...
#   Set the value of the statsd_forward_host variable. Used to forward all
