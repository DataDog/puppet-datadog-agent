# @summary Enable snmp check
#
#
# @param mibs_folder
#   (Deprecated in favor of $init_config)
# @param ignore_nonincreasing_oid
#   (Deprecated in favor of $init_config)
# @param init_config
...
# @param snmp_v1_instances
#   (Deprecated in favor of $instances)
# @param snmp_v2_instances
#   (Deprecated in favor of $instances)
# @param snmp_v3_instances
#   (Deprecated in favor of $instances)
#
#
# @example
