...
class datadog_agent(
  ...
  validate_legacy(Bool, 'validate_bool', $hiera_tags)
  validate_legacy(Array, 'validate_array', $dogstreams)
  validate_legacy(Array, 'validate_array', $facts_to_tags)
  validate_legacy(Bool, 'validate_bool', $puppet_run_reports)
  validate_legacy(String, 'validate_string', $puppetmaster_user)
  validate_legacy(Bool, 'validate_bool', $non_local_traffic)
  validate_legacy(Bool, 'validate_bool', $log_to_syslog)
  validate_legacy(Bool, 'validate_bool', $manage_repo)
  ...
  validate_legacy(Bool, 'validate_bool', $skip_ssl_validation)
  validate_legacy(Bool, 'validate_bool', $skip_apt_key_trusting)
  validate_legacy(Bool, 'validate_bool', $use_curl_http_client)
  validate_legacy(Bool, 'validate_bool', $collect_ec2_tags)
  validate_legacy(Bool, 'validate_bool', $collect_instance_metadata)
  ...
  validate_legacy(Bool, 'validate_bool', $use_pup)
  ...
  validate_legacy(Bool, 'validate_bool', $sd_jmx_enable)
  validate_legacy(String, 'validate_string', $consul_token)
  validate_legacy(Bool, 'validate_bool', $apm_enabled)
  validate_legacy(Bool, 'validate_bool', $agent5_enable)
  validate_legacy(String, 'validate_string', $apm_env)
  validate_legacy(Bool, 'validate_bool', $process_enabled)
