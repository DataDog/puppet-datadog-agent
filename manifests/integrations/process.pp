# @summary Install the necessary configuration for the process integration
#
#
# @param hiera_processes
#   Boolean to grab processes from hiera to allow merging
# @param init_config
# @param processes
#   Array of process hashes, containing these Keys
#
#   search_strings
...
class datadog_agent::integrations::process (
  ...
  if $hiera_processes {
    $local_processes = lookup(
      {
        'name' => 'datadog_agent::integrations::process::processes',
        'merge' => 'unique',
